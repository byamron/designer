...
**Phase 23 Wave 1 shipped 2026-05-03.** All three Wave 1 sub-phases plus follow-ups landed in a single morning: PR #91 (23.A first-token-timestamp coalescer), PR #92 (23.C tool-use expand) + PR #94 (23.C polish — layout-stable region wrapper, screen-reader region semantics, "Nothing to show." error state, and four parked items 23.C.f1–f4 in roadmap), PR #90 (23.D tab-switch keep-mounted) + PR #93 (23.D follow-up — `hasStarted` resync, ComposeDock keyed-by-stateKey, `initialPaint` re-arm, the two BLOCKERs PR #90's brief-bound scope deferred). Per-tab model + effort + attachments persistence captured as Wave 2 / 3 follow-ups. **Wave 2 (23.E per-tab Claude subprocess) and Wave 3 (23.B activity indicator) are next-up.** Documentation gap noted 2026-05-03: PRs #84–#94 had not been logged in `history.md` or reflected in `plan.md` Current Focus until this entry; backfilled in the docs-backfill PR alongside this update.
