...
|---|---|
| Design tokens and axioms | `core-docs/design-system/design-language.md` |
| Component catalog | `core-docs/design-system/component-manifest.json` |
| Decision rationale | `core-docs/design-system/pattern-log.md` |
| Generation log | `core-docs/design-system/generation-log.md` |
